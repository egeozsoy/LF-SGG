...
# from scene_graph_prediction.scene_graph_helpers_pl.model.sparse_convnet.sparse_conv_net_seg import SparseConvSeg
import cv2
import numpy as np
...
from scene_graph_prediction.scene_graph_helpers_psg.model.pix2sg_model.detr import build as build_pix2sg_model, NO_KNOWN_TOKEN, \
    _apply_mapping_to_predictions, _calculate_global_recall, _mean_recall_helper, ENTITY_START, PRED_START
from copy import deepcopy


class SGPNModelWrapperPSG(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log(f'LR', self.optimizers().param_groups[0]['lr'])
    ...
    def plot_attn_map_on_image(self, image, attn_map, name):
        ...
        attn_map = attn_map.cpu().numpy().reshape(16, 16)
